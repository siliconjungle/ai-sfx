// first thing: load & expose RIFFWAVE globally
// (so that `new RIFFWAVE()` inside SoundEffect.generate will work)
var RiffWaveCtor = require('./_riffwave.js');
if (typeof globalThis !== 'undefined') {
  globalThis.RIFFWAVE = RiffWaveCtor;
} else if (typeof window !== 'undefined') {
  window.RIFFWAVE = RiffWaveCtor;
} else if (typeof global !== 'undefined') {
  global.RIFFWAVE = RiffWaveCtor;
}
...
//     // the AMD loader.
//     define(["./_riffwave"], function(RIFFWAVE){
...
;(function(root, factory) {
   ...
   if (typeof module === "object" && module.exports) {
     module.exports = factory(require("./_riffwave"));

   // 2) AMD / browser loaders
   } else if (typeof define === "function" && define.amd) {
     define(["./_riffwave"], factory);

   // 3) Browser global
   } else {
     (typeof window !== "undefined" ? window : root).jsfxr =
       factory((typeof window !== "undefined" ? window : root).RIFFWAVE);
   }
}(typeof self !== "undefined" ? self : this, function(RIFFWAVE) {
  // module code here....
  return {
    "sfxr": sfxr,
    "convert": {
